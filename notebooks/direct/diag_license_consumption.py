...
print("=== pr_metric_view row count for demo-acme-direct project_name ===")
spark.sql("SELECT COUNT(*) FROM playground_prod.consumption_layer.pr_metric_view WHERE project_name LIKE 'demo-acme-direct%'").show()
